...
describe('LinksGist', function(){
  describe('#url', function(){
    it('is built from the gist id', function(){
      ...
      expect(new GitFiddle.LinksGist(location).url).toBe(fiddle_url);
    });
  ...
  describe('#link', function(){
    ...
    it('builds the link', function(){
      var subject = new GitFiddle.LinksGist(location).link;
  ...
  describe('#label', function(){
    it('builds the label', function(){
      //var subject = new GitFiddle.LinksGist(location).label;
